		...
		<Popover open={isNoteInfoOpen} onOpenChange={setNoteInfoOpen}>
			<PopoverTrigger asChild>
				<Button
					...
					aria-label={t.editor.noteInfo}
					title={t.editor.noteInfo}
				>
					<InfoIcon />
				</Button>
			</PopoverTrigger>
			<PopoverContent className="z-101 w-56 p-3" align="end">
				<div className="space-y-1 text-xs">
					<div className="flex justify-between items-center">
						<span className="text-muted-foreground">{t.editor.characters}</span>
						<span>{stats.characters}</span>
					</div>
					<div className="flex justify-between items-center">
						<span className="text-muted-foreground">{t.editor.words}</span>
					...
					<div className="flex justify-between items-center">
						...
						<span>
							{stats.minutes} {t.editor.minutes}
						</span>
					</div>
				</div>
