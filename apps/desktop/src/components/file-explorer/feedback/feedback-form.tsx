...
function FeedbackFormContent({
	...
	const submitButtonLabelByStatus: Record<SubmitStatus, string> = {
		idle: t.explorer.feedbackSend,
		loading: t.explorer.feedbackSending,
		success: t.explorer.feedbackSent,
		error: t.explorer.feedbackError,
	}
		...
		<Form {...form}>
			<form onSubmit={handleSubmit} className="space-y-4">
				<FieldGroup className="gap-3">
					<Field>
						<FieldLabel>{t.explorer.feedbackEmail}</FieldLabel>
						<FormField
					...
					<Field>
						<FieldLabel>{t.explorer.feedbackScreenshot}</FieldLabel>
