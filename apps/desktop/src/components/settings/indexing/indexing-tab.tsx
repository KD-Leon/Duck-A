...
export function IndexingTab() {
	...
	const progressLabel = `${indexedDocCount}/${totalFiles || 0} ${idx.filesIndexed}`
	...
	return (
		<>
			...
			<div className="flex-1 overflow-y-auto p-12">
				<FieldSet>
					<FieldLegend>{idx.title}</FieldLegend>
					<FieldDescription>{idx.description}</FieldDescription>
					<FieldGroup>
						<Field orientation="horizontal">
							<FieldContent>
								<FieldLabel>{idx.embeddingModel}</FieldLabel>
								<FieldDescription>
						...
						<Field>
							<FieldContent>
								<FieldLabel>{idx.indexingProgress}</FieldLabel>
								<FieldDescription>{idx.indexingProgressDesc}</FieldDescription>
							</FieldContent>
							...
							<div className="flex flex-wrap items-center justify-end gap-2 mt-4">
								...
								>
									...
									{isIndexing ? idx.indexing : idx.manuallyIndex}
								</Button>
								<Button
