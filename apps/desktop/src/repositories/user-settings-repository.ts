import type { Language, UIPreferences } from "@mdit/store/core"

export const LANGUAGE_STORAGE_KEY = "mdit-language"
...
const saveLanguage = (value: Language): Language => {
